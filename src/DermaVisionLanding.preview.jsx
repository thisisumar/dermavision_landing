    ...
    <section id="why" className="relative overflow-hidden bg-white py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="space-y-4 text-sm leading-relaxed" style={{ color: C.grey }}>
            <p>
              Your skin is the only organ you can actually see, and it still
              takes most people months to act on a change. Derma Vision closes
              that gap. It turns your phone camera into a record of what your
              skin is doing, week by week.
            </p>
            <p>
              Computer vision compares each scan against reviewed dermatology
              imagery and against your own history — so it notices the slow
              changes your eyes filter out.
            </p>
          </div>
          <div className="space-y-4 text-sm leading-relaxed" style={{ color: C.grey }}>
            <p>
              You get a plain-language read, a confidence score, and a clear
              next step: keep watching, treat at home, or book an appointment.
            </p>
            <p style={{ color: C.ink, fontWeight: 600 }}>
              Derma Vision doesn't diagnose. It helps you decide when a real
              doctor needs to.
            </p>
          </div>
        </div>
